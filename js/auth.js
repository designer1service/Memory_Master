...
import { auth, db }                               from './firebase.js?v=1778247069';
...
import { showScreen, showToast, updateNavUser,
         ...
         clearFormError, renderStats }            from './ui_manager.js?v=1778247069';
import { loadDashboard }                          from './dashboard.js?v=1778247069';
  ...
  try {
    ...
    for (const indexDoc of indexSnap.docs) {
      ...
      const { renderMultiplayerBoard, subscribeToMatch,
        ...
        await import('./multiplayer.js?v=1778247069');
