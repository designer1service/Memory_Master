...
import { db, auth }                                  from './firebase.js?v=1778246870';
import { getState, setState, resetMultiplayerState } from './state_manager.js?v=1778246870';
import { generateBoard }                             from './game_logic.js?v=1778246870';
import {
  showScreen, showToast, updateHPBar,
  updateTurnIndicator, showAbilityToast,
  showResults, showCoinFlip, renderAbilityLog,
} from './ui_manager.js?v=1778246870';
import { updateMultiplayerRating }                   from './dashboard.js?v=1778246870';
...
export async function createRoom() {
  ...
  const { showRoomCode } = await import('./ui_manager.js?v=1778246870');
  showRoomCode(code);
