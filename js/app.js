...
import { initAuthObserver,
         handleLogin, handleRegister, handleGuest, handleLogout } from './auth.js?v=1779965816';
import { startGame, pauseGame, resumeGame, endGame }              from './game_logic.js?v=1779965816';
import { createRoom, joinRoom, leaveMatch }                        from './multiplayer.js?v=1779965816';
import { showScreen, showToast, toggleTheme }                     from './ui_manager.js?v=1779965816';
import { getState, resetGameState, resetMultiplayerState }        from './state_manager.js?v=1779965816';
